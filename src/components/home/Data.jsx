...
const Data = () => {
    return(
        <div className="home__data">
          <h1 className="home__title">Shahid Shaikh
          <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
          ...
          <h3 className="home__subtitle"> Senior Software Engineer
          </h3>
          <p className="home__description">
            High level experience in full stack development, producing quality work.
          </p>
